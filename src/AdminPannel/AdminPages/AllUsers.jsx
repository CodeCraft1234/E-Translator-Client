...
const AllUsers = () => {
  ...
  return (
    <div className="p-20 bg-gradient-to-r from-[#1e1b4b] via-indigo-800 to-[#1e1b4b] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 min-h-full lg:grid-cols-3 p-18 gap-4">
      {users.map((user) => (
        <div key={user.id} className="user-card p-4 border border-gray-300 rounded">
          <img src={user.photo} alt={user.name} className="user-image w-full h-32 object-cover mb-4" />
          <div >
