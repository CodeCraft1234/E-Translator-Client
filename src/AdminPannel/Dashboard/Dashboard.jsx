...
const Dashboard = () => {
    ...
    return (
        <div>
            <div className="min-h-screen top-0 fixed p-3 space-y-2 w-60  dark:bg-gray-900 dark:text-gray-100">
	...
	<div className="divide-y dark:divide-gray-700">
        ...
        <div className="relative">
			...
			<li>
				<a rel="noopener noreferrer" href="/dashboard/addblogs" className="flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
