      ...
      if (file) {
        try {
          ...
          reader.onload = async () => {
            ...
            console.log('Typed Array:', typedArray); // Debugging: Log the typed array
            try {
              const pdfDoc = await PDFDocument.load(typedArray);
              console.log('PDF Document:', pdfDoc); // Debugging: Log the PDF document object
              const text = await extractTextFromPDF(pdfDoc);
              console.log('Extracted Text:', text); // Debugging: Log the extracted text
              setFromText(text);
            } catch (error) {
              console.error("Error loading or processing PDF:", error);
              toast.error("Error loading or processing PDF");
            }
          };
