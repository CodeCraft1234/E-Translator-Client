...
const MeetTeam = () => {
    const Teams = [
        ...
        },
        {
            ...
            image:'https://i.ibb.co/vVNQhzG/44786385-346679162572135-7298686858102308864-n-1.jpg'
        },
        {
    ...
    return (
        <div className="lg:px-24 md:px-8 px-5 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 py-10 mx-10" data-aos="zoom-in" data-aos-duration="1000"
