    ...
    <div>
      <div>
        ...
        <p>
          ...
          use of https://etranslator.netlify.app/'s Website, located at
          https://etranslator.netlify.app/.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use E Translator if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing E Translator, you agreed to
          use cookies in agreement with the https://etranslator.netlify.app/'s
          Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, https://etranslator.netlify.app/ and/or its
          licensors own the intellectual property rights for all material on E
          Translator. All intellectual property rights are reserved. You may
          access this from E Translator for your own personal use subjected to
        ...
        <p>
          ...
          https://etranslator.netlify.app/ does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do
          not reflect the views and opinions of
          https://etranslator.netlify.app/,its agents and/or affiliates.
          ...
          https://etranslator.netlify.app/ shall not be liable for the Comments
        ...
        <p>
          https://etranslator.netlify.app/ reserves the right to monitor all
        ...
        <p>
          You hereby grant https://etranslator.netlify.app/ a non-exclusive
        ...
        <p>
          ...
          https://etranslator.netlify.app/; and (d) the link is in the context
        ...
        <p>
          ...
          sending an e-mail to https://etranslator.netlify.app/. Please include
        ...
        <p>
          No use of https://etranslator.netlify.app/'s logo or other artwork
