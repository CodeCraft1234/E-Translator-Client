  ...
  const cards = [
    {
      id: 1,
      iconClass:
        "https://i.ibb.co/DRDRZxg/precision-modeling-9495577-7781126.webp",
    ...
    },
    {
      id: 3,
      iconClass:
        "https://i.ibb.co/9v8DbX2/support-operator-with-headphones-illustration-for-business-idea-concept-isolated-on-colorful-backgro.webp",
    ...
    },
    {
      id: 5,
      iconClass:
        "https://i.ibb.co/xCk9h4L/3d-illustration-of-a-marketing-strategy-magnet-png.webp",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mx-auto">
          ...
          {cards.map((card, index) => (
            <Tilt key={index} options={defaultOptions} className="col-span-1">
              <div
                className="item m-4 border-2 shadow-md text-center p-4 h-[330px] rounded-lg hover:bg-[#006bcb] hover:text-white transition duration-500 transform hover:-translate-y-1 hover:scale-105"
                data-aos="zoom-in"
              >
                <div className="">
                  <img
