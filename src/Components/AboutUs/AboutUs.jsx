...
const AboutUs = () => {
  return (
    <div>
      ...
      <a
        href="#"
        className="block max-w-7xl mx-auto p-6 bg-white border border-blue-500 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      >
