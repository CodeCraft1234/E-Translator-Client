...
const AboutUs = () => {
    return (
        <div>
            ...
            <a href="#" className="block max-w-7xl mx-auto mt-28 p-6 bg-white border border-blue-500 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" data-aos='fade-down'>
            ...
            <a href="#" className="block max-w-7xl mx-auto mt-20 mb-24 p-6 bg-white border border-blue-500 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700" >
            ...
            <a href="#" className="flex  flex-col mx-auto items-center mt-[250px] bg-white   rounded-lg  md:flex-row md:max-w-7xl dark:border-gray-700 dark:bg-gray-800  mb-24 ">
                <img className=" rotate-[-10deg] object-cover w-full rounded-t-lg h-72 md:h-72 md:w-48 md:rounded-none md:rounded-s-lg pr-12 flex-1  " src={image2} alt="" />
                <div className="flex flex-col justify-between p-4 leading-normal flex-1 " >
